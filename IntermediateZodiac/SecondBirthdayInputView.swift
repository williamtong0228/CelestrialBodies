//
//  SecondBirthdayInputView.swift
//  IntermediateZodiac
//
//  Created by William Tong on 21/3/2021.
//  Copyright © 2021 William Tong. All rights reserved.
//

import SwiftUI

struct SecondBirthdayInputView: View {
    ...
    var body: some View {
        VStack{
            ...
            Button("First Chart") {
                sharing.julianCentury = positions.calcJulianCent(date: reconstructedTime)
            ...
            Button("Second Chart") {
                sharing.julianCenturyC = positions.calcJulianCent(date: reconstructedTime)
...
struct SecondBirthdayInputView_Previews: PreviewProvider {
    static var previews: some View {
        SecondBirthdayInputView()
    }
}
